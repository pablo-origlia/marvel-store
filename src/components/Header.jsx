...
import { Button, Container, Navbar, Badge, Dropdown } from 'react-bootstrap';
...
const Header = ({ productos, changuito, agregarProducto }) => {
          ...
          <DropdownMenu style={{ minWidth: 370 }}>
            {changuito.length > 0 ? (
              <>
                ...
                <Link to='/carrito'>
                  <Button style={{ width: '95%', margin: '0 10px' }}>Ir al carrito</Button>
                </Link>
              </>
            ) : (
              <span style={{ padding: 10 }}>Carrito vacío!</span>
            )}
          </DropdownMenu>
        </Dropdown>
      </Container>
